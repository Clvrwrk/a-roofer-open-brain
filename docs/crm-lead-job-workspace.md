...
## UX parity release — sales-workspace 0.1.43 (2026-09-11)

Companion app 0.6.573A consumes the immutable 0.1.43 archive (SHA256 `f8f8da54556932964254877ed8cc01cd7178a0b3922fd96f4201311dfc184e06`, 103 files): the CC-parity and simplicity pass recorded in CRM_PWA `docs/design/CC-PARITY-UX-REVIEW.md` §10 (three-tab opportunity screen, three-step intake, one-save Notes, call sheet, Today cards, rep-only weekly view, dock above the rail). Contracts/server remain 0.1.22; shared design 0.1.0. No Command Center source outside the vendored package, the pin and the version changed. Local companion build and 573 unit tests pass.
