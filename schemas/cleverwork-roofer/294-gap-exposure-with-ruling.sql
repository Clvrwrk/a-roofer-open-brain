-- 294 — join the dollars (292) to the recorded rulings in office_vendor_agreement_status
--       (245). One decision surface.
-- Applied to prod 2026-08-20.
--
-- 245 and this set's spend view (the file now numbered 292) landed within two minutes of
...
--   292 says HOW MUCH that pair costs     (invoice_count, spend)
...
COMMENT ON VIEW public.v_office_vendor_gap_exposure IS
  'Coverage gaps with BOTH the ruling (mig 245) and the dollars (mig 292). Filter on '
