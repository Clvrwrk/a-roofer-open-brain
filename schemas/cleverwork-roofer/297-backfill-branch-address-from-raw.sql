-- 297 — recover branch addresses that were already sitting in the invoice payload.
--
...
--   * IN THIS REPO: the file is `297-...`. It was renumbered sixteen times (245 -> 251 ->
--     ... -> 297) as parallel sessions claimed numbers on main while this work was in
...
-- The sibling migrations of this set are 296, 298, 299 and 300, all applied to prod.
...
-- 14th renumber 2026-09-15, about an hour later: main took 292 (alias slug-keyed ABC branches).
-- 15th renumber 2026-09-16: main took 293 (June recycled invoices closeout).
-- 16th renumber 2026-09-22: main took 294-295 (AccuLynx link INS prefix + client name,
-- weekly export pending matches). The set moved clear of the contended range to 296-300.
--
-- Found while putting dollars on the coverage gaps (migration 296). The largest single
