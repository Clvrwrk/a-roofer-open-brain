-- 287 — recover branch addresses that were already sitting in the invoice payload.
--
...
--   * IN THIS REPO: the file is `287-...`. It was renumbered eleven times (245 -> 251 ->
--     ... -> 287) as parallel sessions claimed numbers on main while this work was in
...
-- The sibling migrations of this set are 286, 288, 289 and 290, all applied to prod.
...
--
-- Found while putting dollars on the coverage gaps (migration 286). The largest single
