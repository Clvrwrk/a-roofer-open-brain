-- 260 — recover branch addresses that were already sitting in the invoice payload.
--
...
--
-- Found while putting dollars on the coverage gaps (migration 259). The largest single
