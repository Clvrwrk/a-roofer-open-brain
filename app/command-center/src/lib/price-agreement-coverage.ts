...
export interface CoverageVendor {
  ...
  pricedItems: number;
  hasGap: boolean;
  /** The recorded ruling for this pair, from office_vendor_agreement_status via mig 294. */
   ...
   * (v_office_vendor_gap_exposure.agreement_not_reaching, mig 295). Critical for the label:
