...
const valid = { contractVersion: PEC78_CONTRACT_VERSION, subject: "named-agent:maya-chen", personaId: "maya-chen", capability: "mailbox.read", method: "POST", pathname: "/api/agent/runtime/v1/occurrences/claim" };
