...
export function buildMailboxPrompt(message) {
  ...
  return [
    ...
    "Choose track for a clear, in-scope accounting/document/vendor task that should become a PE-CC-DevTeam Linear issue.",
    ...
    "A block also becomes a Linear issue and sends Christopher a Slack routing request.",
