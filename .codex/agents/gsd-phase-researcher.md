...
@/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/thinking-models-research.md
...
```bash
node "/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
