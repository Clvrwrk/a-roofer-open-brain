...
@/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/ios-scaffold.md
...
@/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/executor-examples.md
</deviation_rules>
...
**See @/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/checkpoints.md**
...
**When the orchestrator passes both `MVP_MODE=true` and `TDD_MODE=true`:** Before running the implementation step of any task with `tdd="true"`, run the runtime gate from `@/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/execute-mvp-tdd.md`. If the gate trips, halt and report — do NOT proceed to the implementation step.
...
**Use template:** @/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/templates/summary.md
