...
```
Agent(
  prompt="Read /Users/chussey/Documents/a-roofers-open-brain/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/templates/VALIDATION.md`
