...
- **Global scope**: `/Users/chussey/Documents/a-roofers-open-brain/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/chussey/Documents/a-roofers-open-brain/.codex/notes/`)
...
2. Glob `/Users/chussey/Documents/a-roofers-open-brain/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/chussey/Documents/a-roofers-open-brain/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/chussey/Documents/a-roofers-open-brain/.codex/notes/` — works in any directory
