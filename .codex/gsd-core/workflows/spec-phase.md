...
```bash
INIT=$(node "/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/templates/spec.md.
