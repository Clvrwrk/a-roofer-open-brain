...
@/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/context-budget.md
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/planner-antipatterns.md
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/workflows/execute-plan.md` **inline**
   ...
   **Sequential dispatch for parallel execution (waves with 2+ agents):**
   ...
   Agent(
     ...
     prompt="
       ...
       @/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/checkpoints.md
       @/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/tdd.md
       @/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/worktree-path-safety.md
       ${CONTEXT_WINDOW < 200000 ? '' : '@/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/executor-examples.md'}
       </execution_context>
...
Read and follow `/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
