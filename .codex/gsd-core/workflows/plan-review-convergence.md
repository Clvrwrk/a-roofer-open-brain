...
```bash
INIT=$(node "/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/bin/gsd-tools.cjs" init plan-phase "$PHASE")
...
```bash
PHASE_INFO=$(node "/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
```
...
```bash
node "/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/bin/gsd-tools.cjs" state planned-phase --phase "${PHASE}" --name "${phase_name}" --plans "${PLAN_COUNT}"
```
