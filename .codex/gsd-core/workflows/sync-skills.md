...
INSTALL_JS_GLOBAL="/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
