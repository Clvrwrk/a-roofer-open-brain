...
<required_reading>
@/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/domain-probes.md
@/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/gate-prompts.md
@/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
