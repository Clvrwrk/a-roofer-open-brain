...
```bash
INIT=$(node "/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/chussey/Documents/a-roofers-open-brain/.codex/gsd-core/bin/gsd-tools.cjs" commit \
